...
@section('title', 'Ubah ' . $isMe ? 'Profile' : 'Penduduk')

@section('content_header')
    <h1 class="m-0">Ubah {{ $isMe ? 'Profile' : 'Penduduk' }}</h1>
@stop
@section('content')
    @if (session()->has('error'))
        <div class="alert alert-danger mb-3">{{ session()->get('error') }}</div>
    @endif
    <form method="post" action="{{ route('residents.update', $resident->id) }}" id="penduduk-form" novalidate>
        @csrf
        @method('PUT')
        <div class="row align-items-stretch">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input required type="text" name="no_kk" placeholder="No. KK"
                                            class="form-control" value="{{ old('no_kk') ?? $resident->no_kk }}" />
                                        @if ($errors->has('no_kk'))
                                    ...
                                    <div class="form-group">
                                        <select required type="text" name="jenis_kelamin" placeholder="Jenis Kelamin"
                                            ...
                                            <option value="LAKI_LAKI"
                                                {{ old('jenis_kelamin') ?? $resident->jenis_kelamin == 'LAKI_LAKI' ? 'selected' : '' }}>
                                                Laki-Laki
                                            </option>
                                            <option value="PEREMPUAN"
                                                {{ old('jenis_kelamin') ?? $resident->jenis_kelamin == 'PEREMPUAN' ? 'selected' : '' }}>
                                                Perempuan
                                            </option>
                                        </select>
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <input required type="text" name="agama" placeholder="Agama"
                                            class="form-control" value="{{ old('tempat_lahir') ?? $resident->agama }}" />
                                        @if ($errors->has('agama'))
                                    ...
                                    <div class="form-group">
                                        <select required type="text" name="status_perkawinan"
                                            ...
                                            <option value="MENIKAH"
                                                {{ old('status_perkawinan') ?? $resident->status_perkawinan == 'MENIKAH' ? 'selected' : '' }}>
                                                Menikah</option>
                                            <option value="BELUM_MENIKAH"
                                                {{ old('status_perkawinan') ?? $resident->status_perkawinan == 'BELUM_MENIKAH' ? 'selected' : '' }}>
                                                Belum
                                                Menikah</option>
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <textarea required type="text" name="alamat" placeholder="Alamat" class="form-control" rows="5">{{ old('alamat') ?? $resident->alamat }}</textarea>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="rt_asal" placeholder="RT" class="form-control"
                                            value="{{ old('rt_asal') ?? $resident->rt_asal }}" />
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="rw_asal" placeholder="RW" class="form-control"
                                            value="{{ old('rw_asal') ?? $resident->rw_asal }}" />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="desa_asal" placeholder="Desa" class="form-control"
                                            value="{{ old('desa_asal') ?? $resident->desa_asal }}" />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="kecamatan_asal" placeholder="Kecamatan"
                                            class="form-control"
                                            value="{{ old('kecamatan_asal') ?? $resident->kecamatan_asal }}" />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="kabupaten_asal" placeholder="Kabupaten"
                                            class="form-control"
                                            value="{{ old('kabupaten_asal') ?? $resident->kabupaten_asal }}" />
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="provinsi_asal" placeholder="Provinsi"
                                            class="form-control"
                                            value="{{ old('provinsi_asal') ?? $resident->provinsi_asal }}" />
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="negara_asal" placeholder="Negara"
                                            class="form-control"
                                            value="{{ old('negara_asal') ?? $resident->negara_asal }}" />
            ...
            <input type="hidden" id="id" name="id" placeholder="id" value="{{ $resident->id }}" />
